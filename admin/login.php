...
<head>
    ...
    <title><?php echo $page_title ?> - Mariel</title>
    ...
    <style>
        body {
            background-image: linear-gradient(-225deg, #000000 50%, #923cb5 50%);
        }
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(#923cb5, #000);
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-12 col-lg-4">
                <div style="z-index: 5 !important; " class="card login-box-container">
                    <div class="card-body">
                        <img style="height: 100px;" alt="image" src="/assets/images/kronik.svg" class="KronikLogo1">
                        <div style="margin-top: 30px;" class="authent-text">
                            <p> <span style="font-size: 20px;">MARİEL</span> 'e Hoşgeldiniz!</p>
                        ...
                        <form action="../server/kontrol.php" method="POST">
                            ...
                            <center style="margin-bottom: 10px;">
                                <div class="g-recaptcha" data-sitekey="6Lc-xeshAAAAAHwPVfj2dRCNid8bhU6MG-IUrfZD"></div>
                            </center>
                            <div class="d-grid">
                        ...
                        <center>
                            <p style="color: #fff; width:369px;  font-size: 11px;">Kayıt Olmak için Telegram Adresimize Gelmeniz gerekmektedir.</p>

                            <a style="background-color: #0088cc; width: 369px" class="btn btn-primary" href="https://t.me/mernismariel">
